...
<table class="table custom-table" id="updatedSyllabusTableextra"> 
    ...
    <tbody>
        <?php
        $ctselect="SELECT * FROM fees_master WHERE  academic_year = '$academic_year' AND medium = '$medium' AND student_type = '$student_type' AND standard = '$standard' AND status = 0 AND extra_status = '1'  AND school_id ='$school_id'";
