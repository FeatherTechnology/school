...
while($extraFeeDetailsInfo = $feeDetailsQry->fetch()){
    ...
    $extraAmount = ($extraFeeDetailsInfo['extra_amount'] != '0') ? $extraFeeDetailsInfo['ovrlAllExtraAmnt'] - $extraTotalScholarshipAmnt - $totalextraAmnt : $extraFeeDetailsInfo['ovrlAllExtraAmnt'];
?>
<tr>
    <td>
