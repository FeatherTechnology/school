...
while($amenityFeeDetailsInfo = $feeQueryToUse->fetch()){
    ...
    $amenityAmount = ($amenityFeeDetailsInfo['amenity_amount'] != '0') ? $amenityFeeDetailsInfo['ovrlAllAmenityAmnt'] - $amenityTotalScholarshipAmnt - $totalAmenityAmnt -$totallastAmeityAmnt : $amenityFeeDetailsInfo['amenity_amount'];
?>
<tr>
    <td>
