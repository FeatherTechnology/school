...
if($mediums == '' && $standards == ''){
    ...
    fm.academic_year = '$year_id' AND ((fm.medium = '$mediums' AND fm.student_type = '$studentstype' AND fm.standard = '$standards') OR (ecaf.type='common')) AND fm.extra_status = '1' AND school_id = '$school_id' AND fm.status = '0'";
}
