    ...
    if (in_array($_FILES["file"]["type"], $allowedFileType)) {
        ...
        for ($i = 0; $i < $sheetCount; $i++) {
            ...
            foreach ($Reader as $Row) {
                ...
                $fm_std_id = "";
                if (isset($Row[70])) {
                    $fm_std_id = mysqli_real_escape_string($mysqli, $Row[70]);
                }

                $fm_academic_yr = "";
                if (isset($Row[71])) {
                    $fm_academic_yr = mysqli_real_escape_string($mysqli, $Row[71]);
                }

                $fm_medium = "";
                if (isset($Row[72])) {
                    $fm_medium = mysqli_real_escape_string($mysqli, $Row[72]);
                }

                $fm_fee_particulars = "";
                if (isset($Row[73])) {
                    $fm_fee_particulars = mysqli_real_escape_string($mysqli, $Row[73]);
                }

                $fm_fee_amount = "";
                if (isset($Row[74])) {
                    $fm_fee_amount = mysqli_real_escape_string($mysqli, $Row[74]);
                }

                $fm_fee_type = "";
                if (isset($Row[75])) {
                    $fm_fee_type = mysqli_real_escape_string($mysqli, $Row[75]);
                }

                $fm_student_type = "";
                if (isset($Row[76])) {
                    $fm_student_type = mysqli_real_escape_string($mysqli, $Row[76]);
                }

                $fm_due_date = "";
                if (isset($Row[77])) {
                    $get_due_date = mysqli_real_escape_string($mysqli, $Row[77]);
                ...
                $ac_areaname = "";
                if (isset($Row[108])) {
                    $ac_areaname = mysqli_real_escape_string($mysqli, $Row[108]);
                }

                $ac_fee_amount = "";
                if (isset($Row[109])) {
                    $ac_fee_amount = mysqli_real_escape_string($mysqli, $Row[109]);
                }

                $ac_academic_yr = "";
                if (isset($Row[110])) {
                    $ac_academic_yr = mysqli_real_escape_string($mysqli, $Row[110]);
                }
