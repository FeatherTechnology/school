  ...
  $(document).on("click", "#Submit_Extra, #Submit_Group, #Submit_Amenity", function () { 
    ...
    if(particulars!="" && amount!="" && date!="") {
        $.ajax({
            url: ajaxUrl,
            type: 'POST',
            data: {"fees_id":fees_id,"particulars":particulars,"amount":amount,"date":date,"academic_year":academic_year,"insert_login_id":insert_login_id,"medium":medium, "student_type":student_type, "standard":standard},
            cache: false,
