...
$(document).ready(function(){
  ...
  //Cheque Date from current date.
  // var curDate = $('#receipt_date').val();
  // $('#cheque_date').attr('min', curDate);
...
function getFeesTableFunc(){
  var tempAdmissionFormId = $('#temp_admission_form_id').val();
  var academicYear = $('#student_year_id').val();
  var tempMedium = $('#temp_student_medium').val();
  var tempStudentType = $('#temp_students_type').val();
  var tempStandard = $('#standard_id').val(); 
  getGroupFeesDetails(tempAdmissionFormId, academicYear, tempMedium, tempStudentType, tempStandard);
  // getExtraCurricularActivityDetails(tempAdmissionFormId, academicYear, tempMedium, tempStudentType, tempStandard);
  // getAmenityFeesDetails(tempAdmissionFormId, academicYear, tempMedium, tempStudentType, tempStandard);
...
function getGroupFeesDetails(tempAdmissionFormId, academicYear, tempMedium, tempStudentType, tempStandard){
  $.ajax({
    type : 'POST',
    url : 'FeesCollectionFile/grp/getGroupFeesDetails.php',
    data : {'tempAdmissionFormId': tempAdmissionFormId,'academicYear': academicYear,'tempMedium': tempMedium,'tempStudentType': tempStudentType,'tempStandard': tempStandard},
...
function getExtraCurricularActivityDetails(tempAdmissionFormId, academicYear, tempMedium, tempStudentType, tempStandard){
  $.ajax({
    type : 'POST',
    url : 'FeesCollectionFile/extra/getExtraCurricularActivityDetails.php',
    data : {'tempAdmissionFormId': tempAdmissionFormId,'academicYear': academicYear,'tempMedium': tempMedium,'tempStudentType': tempStudentType,'tempStandard': tempStandard},
    success:(function(reponse){
...
function getAmenityFeesDetails(tempAdmissionFormId, academicYear, tempMedium, tempStudentType, tempStandard){
  $.ajax({
    type : 'POST',
    url : 'FeesCollectionFile/amenity/getAmenityFeesDetails.php',
    data : {'tempAdmissionFormId': tempAdmissionFormId,'academicYear': academicYear,'tempMedium': tempMedium,'tempStudentType': tempStudentType,'tempStandard': tempStandard},
    success:(function(reponse){
