                    	 ...
                    	 <div class="row ">
                           ...
                           <div class="col-md-12 "> 
                            ...
                            <div id="stockinfotableextra">
                                ...
                                <!-- alert messages -->
                                <div id="fees_detailsextraInsertNotOk" class="unsuccessalert">Extra Curricular Activities Already Exists, Please Enter a Different Name!
                                <span class="custclosebtn" onclick="this.parentElement.style.display='none';"><span class="icon-squared-cross"></span></span>
                                </div>

                                <div id="fees_detailsextraInsertOk" class="successalert">Extra Curricular Activities Added Succesfully!<span class="custclosebtn" onclick="this.parentElement.style.display='none';"><span class="icon-squared-cross"></span></span>
                                </div>

                                <div id="fees_detailsextraUpdateOk" class="successalert">Extra Curricular Activities Updated Succesfully!<span class="custclosebtn" onclick="this.parentElement.style.display='none';"><span class="icon-squared-cross"></span></span>
                                </div>

                                <div id="fees_detailsextraDeleteNotOk" class="unsuccessalert">You Don't Have Rights To Delete This Extra Curricular Activities!
                                <span class="custclosebtn" onclick="this.parentElement.style.display='none';"><span class="icon-squared-cross"></span></span>
                                </div>

                                <div id="fees_detailsextraDeleteOk" class="successalert">Extra Curricular Activities Has been Inactivated!<span class="custclosebtn" onclick="this.parentElement.style.display='none';"><span class="icon-squared-cross"></span></span>
                                </div>
                                        ...
                                        <tbody>
                                            <?php if (sizeof($FeesList)>0) { 
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a id="edit_extra" value="<?php echo $FeesList[$j]['fees_id'] ?>"><span class='icon-border_color'></span></a> &nbsp;
                                                        <a id="delete_extra" value="<?php echo $FeesList[$j]['fees_id'] ?>"><span class='icon-trash-2'></span>
                                                        </a>
                                                    </td>
                                                </tr>
                                            <?php } } ?>
                            ...
                            <div id="stockinfotableamenity">
                                ...
                                <!-- alert messages -->
                                <div id="fees_detailsamenityInsertNotOk" class="unsuccessalert">Book Fees Already Exists, Please Enter a Different Name!
                                <span class="custclosebtn" onclick="this.parentElement.style.display='none';"><span class="icon-squared-cross"></span></span>
                                </div>

                                <div id="fees_detailsamenityInsertOk" class="successalert">Book Fees Added Succesfully!<span class="custclosebtn" onclick="this.parentElement.style.display='none';"><span class="icon-squared-cross"></span></span>
                                </div>

                                <div id="fees_detailsamenityUpdateOk" class="successalert">Book Fees Updated Succesfully!<span class="custclosebtn" onclick="this.parentElement.style.display='none';"><span class="icon-squared-cross"></span></span>
                                </div>

                                <div id="fees_detailsamenityDeleteNotOk" class="unsuccessalert">You Don't Have Rights To Delete This Book Fees!
                                <span class="custclosebtn" onclick="this.parentElement.style.display='none';"><span class="icon-squared-cross"></span></span>
                                </div>

                                <div id="fees_detailsamenityDeleteOk" class="successalert">Book Fees Has been Inactivated!<span class="custclosebtn" onclick="this.parentElement.style.display='none';"><span class="icon-squared-cross"></span></span>
                                </div>
                                        ...
                                        <tbody>
                                            <?php if (sizeof($FeesList)>0) { 
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a id="edit_amenity" value="<?php echo $FeesList[$j]['fees_id'] ?>"><span class='icon-border_color'></span></a> &nbsp;
                                                        <a id="delete_amenity" value="<?php echo $FeesList[$j]['fees_id'] ?>"><span class='icon-trash-2'></span>
                                                        </a>
                                                    </td>
                                                </tr>
                                            <?php } } ?>
