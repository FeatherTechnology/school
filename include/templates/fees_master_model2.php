                    	 ...
                    	 <div class="row ">
                           ...
                           <div class="col-md-12 "> 
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 col-12">
                                            ...
                                            <label>Select Ledger</label>
                                                <select class="form-control" id="grp_ledger_name" name="grp_ledger_name">
                                                    <option>Select Ledger</option> 
                                                    <option value="Uniform" <?php  if(isset($grp_ledger_name)) { if($grp_ledger_name == "Uniform") echo 'selected'; }?>>Uniform</option> 
                                                    <option value="Bag" <?php  if(isset($grp_ledger_name)) { if($grp_ledger_name == "Bag") echo 'selected'; }?>>Bag</option> 
                                                    <option value="Sports Kits" <?php  if(isset($grp_ledger_name)) { if($grp_ledger_name == "Sports Kits") echo 'selected'; }?>>Sports Kits</option> 
                                                    <option value="Books" <?php  if(isset($grp_ledger_name)) { if($grp_ledger_name == "Books") echo 'selected'; }?>>Books</option> 
                                                </select>
                                            <span class="text-danger" tabindex="1" id="grp_ledger_nameCheck">Select Ledger Name</span>
                                            </div>
                                        </div>
                            ...
                            <div id="stockinfotableextra">
                                ...
                                <!-- alert messages -->
                                <div id="fees_detailsextraInsertNotOk" class="unsuccessalert">Boys Uniform Fees Already Exists, Please Enter a Different Name!
                                <span class="custclosebtn" onclick="this.parentElement.style.display='none';"><span class="icon-squared-cross"></span></span>
                                </div>

                                <div id="fees_detailsextraInsertOk" class="successalert">Boys Uniform Fees Added Succesfully!<span class="custclosebtn" onclick="this.parentElement.style.display='none';"><span class="icon-squared-cross"></span></span>
                                </div>

                                <div id="fees_detailsextraUpdateOk" class="successalert">Boys Uniform Fees Updated Succesfully!<span class="custclosebtn" onclick="this.parentElement.style.display='none';"><span class="icon-squared-cross"></span></span>
                                </div>

                                <div id="fees_detailsextraDeleteNotOk" class="unsuccessalert">You Don't Have Rights To Delete This Boys Uniform Fees!
                                <span class="custclosebtn" onclick="this.parentElement.style.display='none';"><span class="icon-squared-cross"></span></span>
                                </div>

                                <div id="fees_detailsextraDeleteOk" class="successalert">Boys Uniform Fees Has been Inactivated!<span class="custclosebtn" onclick="this.parentElement.style.display='none';"><span class="icon-squared-cross"></span></span>
                                </div>
                                ...
                                <div class="col-md-12 "> 
                                    <div class="row">
                                        ...
                                        <label>Select Ledger</label>
                                            <div class="form-group">
                                                <select class="form-control select2" id="extra_ledger_name" name="extra_ledger_name">
                                                    <option>Select Ledger</option> 
                                                    <option value="uniform" <?php  if(isset($extra_ledger_name)) { if($extra_ledger_name == "Uniform") echo 'selected'; }?>>Uniform</option> 
                                                    <option value="Bag" <?php  if(isset($extra_ledger_name)) { if($extra_ledger_name == "Bag") echo 'selected'; }?>>Bag</option> 
                                                    <option value="Sports Kits" <?php  if(isset($extra_ledger_name)) { if($extra_ledger_name == "Sports Kits") echo 'selected'; }?>>Sports Kits</option> 
                                                    <option value="Books" <?php  if(isset($extra_ledger_name)) { if($extra_ledger_name == "Books") echo 'selected'; }?>>Books</option> 
                                                </select>
                                            </div>
                                        </div>
                                        <div class="col-xl-2 col-lg-4 col-md-6 col-sm-6 col-12">
                            ...
                            <div id="stockinfotableamenity">
                                ...
                                <!-- alert messages -->
                                <div id="fees_detailsamenityInsertNotOk" class="unsuccessalert">Girls Uniform Fees Already Exists, Please Enter a Different Name!
                                <span class="custclosebtn" onclick="this.parentElement.style.display='none';"><span class="icon-squared-cross"></span></span>
                                </div>

                                <div id="fees_detailsamenityInsertOk" class="successalert">Girls Uniform Fees Added Succesfully!<span class="custclosebtn" onclick="this.parentElement.style.display='none';"><span class="icon-squared-cross"></span></span>
                                </div>

                                <div id="fees_detailsamenityUpdateOk" class="successalert">Girls Uniform Fees Updated Succesfully!<span class="custclosebtn" onclick="this.parentElement.style.display='none';"><span class="icon-squared-cross"></span></span>
                                </div>

                                <div id="fees_detailsamenityDeleteNotOk" class="unsuccessalert">You Don't Have Rights To Delete This Girls Uniform Fees!
                                <span class="custclosebtn" onclick="this.parentElement.style.display='none';"><span class="icon-squared-cross"></span></span>
                                </div>

                                <div id="fees_detailsamenityDeleteOk" class="successalert">Girls Uniform Fees Has been Inactivated!<span class="custclosebtn" onclick="this.parentElement.style.display='none';"><span class="icon-squared-cross"></span></span>
                                </div>
                                ...
                                <div class="col-md-12 "> 
                                    <div class="row">
                                        <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 col-12">
                                            <div class="form-group">
                                                <label>Particulars</label>
                                                    ...
                                                    <input  name="standard" id="standard" class="form-control" value="<?php if(isset($standard )) echo $standard ; ?>" type="hidden">
                                                    <input  name="insert_login_id" id="insert_login_id" class="form-control" value="<?php if(isset($userid )) echo $userid ;?>" type="hidden">
                                                    <input  name="amenity_particulars" id="amenity_particulars" placeholder="Particulars" class="form-control" <?php if(isset($amenity_particulars)) echo $amenity_particulars; ?>  type="text">
                                            </div>
                                        </div>
                                        <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 col-12">
                                            <div class="form-group">
                                                <label>Amount</label>
                                                <input  name="amenity_amount" id="amenity_amount" placeholder="Amount" class="form-control"  type="number">
                                        ...
                                        <label>Select Ledger</label>
                                            <div class="form-group">
                                                <select class="form-control select2" id="amenity_ledger_name" name="amenity_ledger_name">
                                                    <option>Select Ledger</option> 
                                                    <option value="uniform" <?php  if(isset($amenity_ledger_name)) { if($amenity_ledger_name == "Uniform") echo 'selected'; }?>>uniform</option> 
                                                    <option value="Bag" <?php  if(isset($amenity_ledger_name)) { if($amenity_ledger_name == "Bag") echo 'selected'; }?>>Bag</option> 
                                                    <option value="Sports Kits" <?php  if(isset($amenity_ledger_name)) { if($amenity_ledger_name == "Sports Kits") echo 'selected'; }?>>Sports Kits</option> 
                                                    <option value="Books" <?php  if(isset($amenity_ledger_name)) { if($amenity_ledger_name == "Books") echo 'selected'; }?>>Books</option> 
                                                </select>
                                            </div>
                                        </div>
                                        <div class="col-xl-2 col-lg-4 col-md-6 col-sm-6 col-12">
                                            <div class="form-group">
                                            <button style="margin-top:20px;" type="button" name="Submit_Amenity" id="Submit_Amenity" class="btn btn-primary" value="submit" tabindex="10">Save</button></div>
                                        </div>
                                    </div>
                                </div>
                                <div id="updatedstockinfotableamenity"> 
                                    ...
                                    <thead>
                                        ...
                                        <tbody>
                                            <?php if (sizeof($FeesList)>0) { 
                                                ...
                                                <tr>
                                                    <td class="col-md-2 col-xl-2"><?php echo $j+1; ?></td>
                                                    <td><?php  echo $FeesList[$j]['amenity_particulars']; ?></td>
                                                    <td><?php  echo $FeesList[$j]['amenity_amount']; ?></td>
                                                    <td>
                                                        <a id="edit_fees" value="<?php echo $FeesList[$j]['fees_id'] ?>"><span class='icon-border_color'></span></a> &nbsp;
                                                        <a id="delete_fees" value="<?php echo $FeesList[$j]['fees_id'] ?>"><span class='icon-trash-2'></span>
                                                        </a>
