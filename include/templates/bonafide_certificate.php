 ...
 if(isset($_POST['SubmitConductCertificate']) && $_POST['SubmitConductCertificate'] != '')
 {
    ...
    <style>
      span.top:before {
          ...
          @media print {
  .custom-border {
    border-color: black !important; /* Set the desired border color */
  }
}
    </style>
<div class="page-header">
    <ol class="breadcrumb">
        <li class="breadcrumb-item">SM - Bonafide  Certicate Date Of Birth</li>
        ...
        <form id = "customer_master" name="customer_master" action="" method="post" enctype="multipart/form-data"> 
                ...
                <div class="row gutters">
                    ...
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        ...
                        <div class="card">
                                <div class="card-header">Bonafide  Certificate
                                    ...
                                    <div class="card-body">
                                        ...
                                        <u><hr></u>
                                                    ...
                                                    echo $currentDate;
                                                    ?></p><br><br>
                                                        <h5>TO WHOMESOEVER IT MAY CONCERN</h5><br><br></center>
                                                    <h3 style="text-transform: capitalize;font-weight: lighter;">This Is To Certify That <span class="top">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $student_name; ?></span><br><br> Is a Bonafide Student Of Our School Studying 
                                                    <span class="top1">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $standard; ?></span><br><br>
                                                     In The academic year  <span class="top2">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $standard; ?></span><br><br>
                                                     his/her admission number <span class="top3">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $admission_number; ?></span><br><br>
                                                     and date of birth is <span class="top4">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $date_of_birth; ?></span><br><br>
                                                    as per our school record.</h3><br><br><br><br><br>
