...
$id=0;
 if(isset($_POST['SubmitTransferCertificate']) && $_POST['SubmitTransferCertificate'] != '')
 {
    if(isset($_POST['id']) && $_POST['id'] >0 && is_numeric($_POST['id'])){     
        ...
        ?>
         <script>location.href='<?php echo $HOSTPATH; ?>edit_transfer_certificate&msc=2';</script> 
        <?php   
    }
    else{   
        $addTransferCertificateCreation = $userObj->addTransferCertificateCreation($mysqli,$userid);   
        ?>
        <script>location.href='<?php echo $HOSTPATH; ?>edit_transfer_certificate&msc=1';</script>
        <?php
    }
 }  
    ...
    if($del>0)
    {
        ...
        ?>
        <script>location.href='<?php echo $HOSTPATH; ?>edit_transfer_certificate&msc=3';</script>
    <?php	
    }
                                ...
                                <div class="card-header">Transfer Certificate</div>
                                    <div class="card-body">
                                        <div class="row">
                                            ...
                                            <div class="col-xl-5 col-lg-4 col-md-6 col-sm-6 col-12">
                                                <div class="form-group">
                                                    <input type="text"  tabindex="4"  name="certificate_number" id="certificate_number" class="form-control" value="<?php if(isset($certificate_number)) echo $certificate_number ; ?>" placeholder="">
                                                </div>
                                            </div>
                                            <div class="col-md-1"></div>
                                            <div class="col-xl-5 col-lg-4 col-md-6 col-sm-6 col-12"></div>
                                            <div class="col-md-1">
                                                <div class="form-group">
                                             ...
                                             <div class="col-xl-5 col-lg-4 col-md-6 col-sm-6 col-12">
                                                <div class="form-group">
                                                    <input type="date"  tabindex="5"  name="transfer_date" id="transfer_date" class="form-control" value="<?php if(isset($transfer_date)) echo $transfer_date; ?>" placeholder="">
                                                </div>
                                            </div>
                                        </div><br><br><br><br>
                                    <div class="row ">
                                        <div class="col-md-12"> 
                                            <div class="row">
                                                ...
                                                <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                                                    <div class="form-group">
                                                        <input type="text"  tabindex="6"  name="school_name" id="school_name" class="form-control" value="<?php if(isset($school_name)) echo $school_name; ?>" placeholder="">
                                                        <input type="text"  tabindex="7"  name="district_educational" id="district_educational" class="form-control" value="<?php if(isset($district_educational)) echo $district_educational; ?>" placeholder="">
                                                        <input type="text"  tabindex="8"  name="revenue_district" id="revenue_district" class="form-control" value="<?php if(isset($revenue_district)) echo $revenue_district; ?>" placeholder="">
                                                    </div>
                                                </div>
                                                <div class="col-md-1">
                                                    <div class="form-group">
                                                ...
                                                <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                                                    <div class="form-group">
                                                        <input type="text"  tabindex="9"  name="student_name" id="student_name" class="form-control" value="<?php if(isset($student_name)) echo $student_name; ?>" placeholder="">
                                                    </div>
                                                </div>
                                                <div class="col-md-1">
                                                    <div class="form-group">
                                                ...
                                                <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                                                    <div class="form-group">
                                                        <input type="text"  tabindex="10"  name="parents_name" id="parents_name" class="form-control" value="<?php if(isset($parents_name)) echo $parents_name; ?>" placeholder="">
                                                    </div>
                                                ...
                                                <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                                                    <div class="form-group">
                                                        <input type="text"  tabindex="11"  name="nationality" id="nationality" class="form-control" value="<?php if(isset($nationality)) echo $nationality; ?>" placeholder="">
                                                    </div>
                                                </div><div class="col-md-1">
                                                    <div class="form-group">
                                                        <label>5.</label>
                                                ...
                                                <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                                                    <div class="form-group">
                                                        <input type="text"  tabindex="12"  name="caste" id="caste" class="form-control" value="<?php if(isset($caste)) echo $caste; ?>" placeholder="">
                                                    </div>
                                                </div><div class="col-md-1">
                                                    <div class="form-group">
                                                        <label>6.</label>
                                                ...
                                                <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                                                    <div class="form-group">
                                                        <input type="text"  tabindex="13"  name="gender" id="gender" class="form-control" value="<?php if(isset($gender)) echo $gender; ?>" placeholder="">
                                                    </div>
                                                </div><div class="col-md-1">
                                                    <div class="form-group">
                                                        <label>7.</label>
                                                ...
                                                <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                                                    <div class="form-group">
                                                        <input type="date"  tabindex="14"  name="admission_date" id="admission_date" class="form-control" value="<?php if(isset($admission_date)) echo $admission_date; ?>" placeholder="">
                                                        <input type="text"  tabindex="15"  name="register_words" id="register_words" class="form-control" value="<?php if(isset($register_words)) echo $register_words; ?>" placeholder="">
                                                    </div>
                                                </div><div class="col-md-1">
                                                    <div class="form-group">
                                                        <label>8.</label>
                                                ...
                                                <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                                                    <div class="form-group">
                                                        <input type="text"  tabindex="16"  name="personal_identification" id="personal_identification" class="form-control" value="<?php if(isset($personal_identification)) echo $personal_identification; ?>" placeholder="">
                                                    </div>
                                                </div><div class="col-md-1">
                                                    <div class="form-group">
                                                        <label>9.</label>
                                                ...
                                                <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                                                    <div class="form-group">
                                                        <input type="text"  tabindex="17"  name="date_first_admission" id="date_first_admission" class="form-control" value="<?php if(isset($date_first_admission)) echo $date_first_admission; ?>" placeholder="">
                                                    </div>
                                                </div><div class="col-md-1">
                                                    <div class="form-group">
                                                        <label>10.</label>
                                                ...
                                                <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                                                    <div class="form-group">
                                                        <input type="text"  tabindex="18"  name="standard" id="standard" class="form-control" value="<?php if(isset($standard)) echo $standard; ?>" placeholder="">
                                                    </div>
                                                </div><div class="col-md-1">
                                                    <div class="form-group">
                                                        <label>11.</label>
                                                ...
                                                <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                                                    <div class="form-group">
                                                        <input type="text"  tabindex="19"  name="promotion" id="promotion" class="form-control" value="<?php if(isset($promotion)) echo $promotion; ?>" placeholder="">
                                                    </div>
                                                </div><div class="col-md-1">
                                                    <div class="form-group">
                                                        <label>12.</label>
                                                ...
                                                <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                                                    <div class="form-group">
                                                        <input type="text"  tabindex="20"  name="scholarship" id="scholarship" class="form-control" value="<?php if(isset($scholarship)) echo $scholarship; ?>" placeholder="">
                                                    </div>
                                                </div><div class="col-md-1">
                                                    <div class="form-group">
                                                        <label>13.</label>
                                                ...
                                                <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                                                    <div class="form-group">
                                                        <input type="text"  tabindex="21"  name="medical_inspection" id="medical_inspection" class="form-control" value="<?php if(isset($medical_inspection)) echo $medical_inspection; ?>" placeholder="">
                                                    </div>
                                                </div><div class="col-md-1">
                                                    <div class="form-group">
                                                        <label>14.</label>
                                                ...
                                                <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                                                    <div class="form-group">
                                                        <input type="text"  tabindex="22"  name="date_school" id="date_school" class="form-control" value="<?php if(isset($date_school)) echo $date_school; ?>" placeholder="">
                                                    </div>
                                                </div><div class="col-md-1">
                                                    <div class="form-group">
                                                        <label>15.</label>
                                                ...
                                                <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                                                    <div class="form-group">
                                                        <input type="text"  readonly tabindex="23"  name="conduct" id="conduct" class="form-control" value="Good" placeholder="">
                                                    </div>
                                                </div><div class="col-md-1">
                                                    <div class="form-group">
                                                        <label>16.</label>
                                                ...
                                                <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                                                    <div class="form-group">
                                                        <input type="date"  tabindex="24"  name="date_parents" id="date_parents" class="form-control" value="<?php if(isset($date_parents)) echo $date_parents; ?>" placeholder="">
                                                    </div>
                                                </div><div class="col-md-1">
                                                    <div class="form-group">
                                                        <label>17.</label>
                                                ...
                                                <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                                                    <div class="form-group">
                                                        <input type="date"  tabindex="25"  name="date_of_transfer_certificate" id="date_of_transfer_certificate" class="form-control" value="<?php if(isset($date_of_transfer_certificate)) echo $date_of_transfer_certificate; ?>" placeholder="">
                                                    </div>
                                                </div>
