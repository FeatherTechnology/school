                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <table id="example" class="display" cellspacing="0" width="100%">
                                    ...
                                    <tbody>
                                    <?php
                                        $ctselect="SELECT * FROM student_creation WHERE status=1 AND deleted_student =0"; 
                                        ...
                                        <td><a href="studentFile/ajaxDelStudentsFetch.php?upd=<?php echo $sid; ?>" title='Edit details'>Restore</a></td>
