...
<div class="page-header">
    <ol class="breadcrumb">
        <li class="breadcrumb-item">SM - Transport Fees Master </li>
    </ol>
...
<input type="hidden" class="form-control" value="<?php if(isset($transport_fees_master_id)) echo $transport_fees_master_id; ?>"  id="id" name="id" aria-describedby="id" placeholder="Enter id">
 		<!-- Row start -->
                            ...
                            <div id="stockinfotable">
                                <div class="card">
                                    <div class="card-header" style="background-image: linear-gradient(white, #e6d9cc);">
                                        <div class="card-title">Transport Fees</div>
                                    </div>
                                </div>
                                <!-- alert messages -->
                                <div id="fees_detailsInsertNotOk" class="unsuccessalert">Transport Fees Already Exists, Please Enter a Different Name!
                                <span class="custclosebtn" onclick="this.parentElement.style.display='none';"><span class="icon-squared-cross"></span></span>
                                </div>

                                <div id="fees_detailsInsertOk" class="successalert">Transport Fees Added Succesfully!<span class="custclosebtn" onclick="this.parentElement.style.display='none';"><span class="icon-squared-cross"></span></span>
                                </div>

                                <div id="fees_detailsUpdateOk" class="successalert">Transport Fees Updated Succesfully!<span class="custclosebtn" onclick="this.parentElement.style.display='none';"><span class="icon-squared-cross"></span></span>
                                </div>

                                <div id="fees_detailsDeleteNotOk" class="unsuccessalert">You Don't Have Rights To Delete This Transport Fees!
                                <span class="custclosebtn" onclick="this.parentElement.style.display='none';"><span class="icon-squared-cross"></span></span>
                                </div>

                                <div id="fees_detailsDeleteOk" class="successalert">Transport Fees Has been Inactivated!<span class="custclosebtn" onclick="this.parentElement.style.display='none';"><span class="icon-squared-cross"></span></span>
                                </div>
                                        ...
                                        <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 col-12">
                                            <div class="form-group">
                                                ...
                                                <input  name="lastInsertId" id="cc" class="form-control" value="<?php if(isset($lastInsertId )) echo $lastInsertId ; ?>" type="hidden">
                                                    <input  name="transport_fees_master_id" id="transport_fees_master_id" class="form-control" value="<?php if(isset($transport_fees_master_id )) echo $transport_fees_master_id ; ?>" type="hidden">
                                        ...
                                        <tbody>
                                            <?php if (sizeof($FeesList)>0) { 
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a id="edit_grp" value="<?php echo $FeesList[$j]['transport_fees_master_id'] ?>"><span class='icon-border_color'></span></a> &nbsp;
                                                        <a id="delete_grp" value="<?php echo $FeesList[$j]['transport_fees_master_id'] ?>"><span class='icon-trash-2'>Delete</span></a>
                                                    </td>
                                                </tr>
                                            <?php } } ?>
                                        </tbody>
