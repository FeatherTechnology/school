...
<nav id="sidebar" class="sidebar-wrapper" style="background-color:#1b6aaa;">
	...
	<div class="sidebar-menu sidebar-brand" style="background-color: #1b6aaa">
		<ul>
			<li class="sidebar">
				<a href="dashboard">
					<span class="menu-text" style="text-align: center;">
	...
	<div class="sidebar-content">
		...
		<div class="sidebar-menu">
			<ul>
				...
				<?php }
				if (isset($master_module) && $master_module == 0) { ?>
					...
					<li class="sidebar-dropdown">
						...
						<div class="sidebar-submenu">
							<ul>
								...
								<?php }
								if (isset($syllabus_sub_module) && $syllabus_sub_module == 0) { ?>
									<li class="sidebar-dropdown1">
										...
										<div class="sidebar-submenu1">
											<ul>
												...
												<?php }
												if (isset($allocation_view) && $allocation_view == 0) { ?>
													<li>
				...
				<?php }
				if (isset($staff_module) && $staff_module == 0) { ?>
					<li class="sidebar-dropdown">
						<a href="javascript:void(0)">
				...
				<?php }
				if (isset($student_module) && $student_module == 0) { ?>
					<li class="sidebar-dropdown">
						<a href="javascript:void(0)">
							<i class="icon-user"></i>
					...
					<li class="sidebar-dropdown">
						...
						<div class="sidebar-submenu">
							<ul>
								...
								<?php }
								if (isset($fees_collection) && $fees_collection == 0) { ?>
									<li>
				...
				<?php }
				if (isset($sms_module) && $sms_module == 0) { ?>
					<!-- SMS Module START -->
					<li class="sidebar-dropdown">
						<a href="javascript:void(0)">
				...
				<?php }
				if (isset($report_module) && $report_module == 0) { ?>
					<li class="sidebar-dropdown">
						<a href="javascript:void(0)">
						...
						<div class="sidebar-submenu">
									...
									<li class="sidebar-dropdown1">
										...
										<div class="sidebar-submenu1">
											<ul>
												...
												<?php }
												if (isset($class_wise_list) && $class_wise_list == 0) { ?>
													<li>
														<a href="class_wise_list"><i class="icon-list"></i>Class wise List</a>
													</li>
												<?php }
												if (isset($new_admission_list) && $new_admission_list == 0) { ?>
													<li>
														<a href="new_admission_list"><i class="icon-local_library"></i>New Admission List</a>
													</li>
												<?php }
												if (isset($register_of_admission) && $register_of_admission == 0) { ?>
													<li>
														<a href="register_of_admission"><i class="icon-documents"></i>Register of Admission</a>
													</li>
												<?php }
												if (isset($student_transport_list) && $student_transport_list == 0) { ?>
													<li>
							...
							<?php }
							if (isset($fee_details_sub_module) && $fee_details_sub_module == 0) { ?>
								<!-- Student report END -->
