...
<style>
#show_student_fees_summary_list th ,#show_student_fees_summary_list td {
...
<div class="page-header">
    <ol class="breadcrumb">
        <li class="breadcrumb-item">SM - Fees Summary Report </li>
    </ol>
</div>
<!-- Page header end -->
...
<div class="main-container">
    <!--form start-->
    <form id="student_fees_summary_form" name="student_fees_summary_form" method="post" enctype="multipart/form-data">
        <!-- card start -->
        <div class="card">
            <div class="card-body">
                <div class="row">
                ...
                <div class="col-xl-1 col-lg-1 col-md-1 col-sm-1 col-12"></div>
                    ...
                    <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                        <div class="form-group">
                            <input type="button" name="fees_summary_table_view" id="fees_summary_table_view" class="btn btn-primary" value="View" tabindex="3">
                        </div>
                    </div>
