...
<div class="page-header">
    <ol class="breadcrumb">
        <li class="breadcrumb-item">SM - Pending Fees Details Report </li>
    </ol>
</div>
<!-- Page header end -->
...
<div class="main-container">
    <!--form start-->
    <form id="student_pending_fee_form" name="student_pending_fee_form" method="post" enctype="multipart/form-data">
        <!-- Row start -->
