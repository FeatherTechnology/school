...
<div class="page-header">
    <ol class="breadcrumb">
        <li class="breadcrumb-item">SM - OverAll Scholarship Fee Details Report </li>
    </ol>
</div>
<!-- Page header end -->
...
<div class="main-container">
    <!--form start-->
    <form id="student_overall_scholarship_fee_form" name="student_overall_scholarship_fee_form" method="post" enctype="multipart/form-data">
        <!-- Row start -->
                    ...
                    <div class="card-body">
                        <div class="row ">
                            ...
                            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                                <div class="form-group">
                                    <input type="button" name="overallscholarship_Fees_table_view" id="overallscholarship_Fees_table_view" class="btn btn-primary" value="View" tabindex="5">
                                </div>
                            </div>
        ...
        <div class="card" id="listCard" style="display: none;">
            <div class="card-body">
                <div id="showStudentScholarshipFeeList"></div>
            </div>
        </div>
    </form>
</div>