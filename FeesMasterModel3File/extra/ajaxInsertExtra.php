...
if($extra_academic_year != '' && $extra_medium != '' && $extra_standard != '' && $extrac_particulars != '' && $extra_Status == 0){ ;
	...
	if($fees_id>0){
	    ...
	    $insertClass=$con->query("INSERT INTO fees_master(academic_year,medium,standard,extra_particulars,extra_amount,extra_date,insert_login_id,extra_status) VALUES('".strip_tags($academic_year)."','".strip_tags($medium)."',
